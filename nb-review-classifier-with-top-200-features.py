...
# 200
# extracting features!
# will now start to classify
# classification done
# Accuracy:  74.77064220183486
# Most Informative Features
#       contains(amazing) = True           Positi : Negati =    123.0 : 1.0
#          contains(worst) = True           Negati : Positi =     46.2 : 1.0
#       contains(pathetic) = True           Negati : Positi =     35.0 : 1.0
#      contains(excellent) = True           Positi : Negati =     24.1 : 1.0
#           contains(lot) = True           Negati : Positi =     21.9 : 1.0
